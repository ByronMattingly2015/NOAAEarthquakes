...
* Your package must at least contain the following files: <s>.travis.yml</s>[appveyor.yml](https://github.com/ByronMattingly2015/NOAAEarthquakes/blob/master/appveyor.yml), 
